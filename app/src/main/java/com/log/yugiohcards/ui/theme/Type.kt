package com.log.yugiohcards.ui.theme
...
private val ygoFontFamily = FontFamily(fonts = listOf(light, regular, medium, semibold))

val captionTextStyle = TextStyle(
    fontFamily = ygoFontFamily,
    fontWeight = FontWeight.W400,
    fontSize = 16.sp
)

val ygoTypography = Typography(
    h1 = TextStyle(
        fontFamily = ygoFontFamily,
